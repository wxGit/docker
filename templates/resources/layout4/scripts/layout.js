...
var Layout = function () {
    ...
    var initMenuURL = function ($scope, $http, $modal, $window, $state, callback) {
        ...
        var menus = [
            {
                "name": "代码构建", "icon": "quanxianguanlix", "url":"dashboard"
            },
            {
                "name": "镜像仓库", "icon": "jigou","url":"partyRoleQuit"
            },
            {
                "name": "容器服务", "icon": "flower",
                "subList": [
                    {"name": "应用管理", "icon": "zhongduanchaxun", "url": "partyRoleQuit"},
                    {"name": "存储管理", "icon": "mianshi", "url": "partyRoleModify"}
                ]
            },
            {
                "name": "PaaS服务", "icon": "kefu","url":"partyRoleImageManage"
            },
            {
                "name": "应用编排", "icon": "address","url":"productModify"
            },
            {
                "name": "权限管理", "icon": "liuyan","url":"raisingPeriodEntry"
            },
            {
                "name": "代码初始化", "icon": "duanxin","url":"businessFlowEntry"
            }
        ];
